...
#define Is_planeslevel(x)	(on_level(x, &planes_level))
#define Is_earthlevel(x)	(on_level(x, &planes_level) && dungeon_topology.planes_variant == EARTH_PLANE)
#define Is_waterlevel(x)	(on_level(x, &planes_level) && dungeon_topology.planes_variant == WATER_PLANE)
#define Is_firelevel(x)		(on_level(x, &planes_level) && dungeon_topology.planes_variant == FIRE_PLANE)
#define Is_airlevel(x)		(on_level(x, &planes_level) && dungeon_topology.planes_variant == AIR_PLANE)
...
#define Is_rod_level(x)		(on_level(x, &rod_level))
#define Is_wiz1_level(x)	(FALSE)
#define Is_wiz2_level(x)	(FALSE)
#define Is_wiz3_level(x)	(FALSE)
